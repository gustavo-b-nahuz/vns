...
def plot_final_solution(graph, best_sol, best_tour, radius):
    ...
    # nós
    # -------------------------
    nodes_red = nx.draw_networkx_nodes(
        graph, pos,
        nodelist=best_sol,
        node_color="red",
        node_size=140,
    ...
    nodes_red.set_zorder(5)

    nodes_gray = nx.draw_networkx_nodes(
        graph, pos,
    ...
    nodes_gray.set_zorder(3)

    nodes_blue = nx.draw_networkx_nodes(
        graph, pos,
    ...
    for text in labels.values():
        text.set_zorder(10)   # maior que todos os nós
